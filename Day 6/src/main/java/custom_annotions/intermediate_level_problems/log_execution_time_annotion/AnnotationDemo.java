package custom_annotions.intermediate_level_problems.log_execution_time_annotion;
...
public class AnnotationDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Executing and measuring time for annotated methods
        TaskHandler handler = new TaskHandler();
        for (Method m : TaskHandler.class.getDeclaredMethods()) {
            if (m.isAnnotationPresent(LogExecutionTime.class)) {
                System.out.println("Measuring execution time for method: " + m.getName());
                m.invoke(handler);
            }
        }
    }
